        ...
        <nav class="container flex flex-col sm:flex-row items-center gap-4 text-white py-6">
            <RouterLink :to="{name: 'home'}">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-2xl">The Local Weater</p>
                </div>
            </RouterLink>
            <div class="flex gap-3 flex-1 justify-end">
                ...
                @click="addCity" class="fa-solid fa-plus text-xl hover:text-weather-secondary duration-150 cursor-pointer"></i>
            ...
            <BaseModal :modalActive="modalActive" @close-modal="toggleModal">
                <div class="text-black">
                    ...
                    <ol class="list-decimal list-inside mb-4">
                        ...
                        <li>Select a city within the results, this will take you to the current warther for your selection.</li>
                    ...
                    <p>If you no longer wish to track a city, simply select the city within the home page. At the bottom of the page, there will be am option to delete the city.</p>
                </div>
            </BaseModal>
        </nav>
    </header>
